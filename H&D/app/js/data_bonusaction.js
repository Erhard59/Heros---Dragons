data_bonusaction = [
    {
        ...
        icon: "crossed-swords",
        subtitle: "Attaquer avec une deuxiême arme",
        description: "Attaquer avec une deuxiême arme",
        reference: "PHB, pg. 195.",
        bullets: [
            "Uniquement utilisable si vous effectuez une action <b>Attaquer</b> avec une arme de mélée légêre que vous tenez à une main.",
            "Vous pouvez faire une attaque avec une autre arme de mélée légêre que vous portez dans votre autre main. N'ajoutez pas votre bonus de caractéristique aux dégâts de cette attaque, à moins qu'il soit négatif",
            "Si l'une ou l'autre de vos armes possêde la propriété <i>lancer</i>, vous pouvez lancer l'arme au lieu de faire une attaque de mélée avec."
        ]
    },
    {
