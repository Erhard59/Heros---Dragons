data_action = [
    ...
    },
    {
        ...
        bullets: [
            ...
            "Si vous remportez ce test d'opposition, vous avez le choix entre faire tomber votre cible à terre, ou bien la répousser d'une distance de 1,50 mêtres de vous."
        ]
    },
    {
        ...
        bullets: [
			...
			"Si l'incantateur subit des dégâts pendant sa concentration, il doit réussir un jet de sauvegarde de Constitution. Le DD est de 10 ou la moitié du total de dégâts reÃ§us si plusieurs attaques lui sont portées. Par contre il doit effectuer un jet de sauvegarde dês qu'une attaque réussie lui fait des dégâts."
        ]
    },
    {
        title: "Se précipiter",
        ...
        bullets: [
            "Ce bonus de déplacement est égal à votre vitesse, aprês avoir appliqué tous vos modificateurs éventuels. Tout effet qui augmente ou réduit votre vitesse modifie du même montant votre bonus de déplacement.",
			"Ainsi, si votre vitesse de 9 mêtres est réduite à 4,50 mêtres, votre action se précipiter vous permettra d'effectuer un déplacement de 9 mêtres à votre tour."
        ]
    },
    {
        title: "Se désengager",
    ...
    },
    {
        ...
        bullets: [
            ...
            "Vous pouvez aussi aider un allié à attaquer une autre créature située à 1,50 mêtre ou moins de vous. Si votre allié attaque cette cible avant le début de votre prochain tour, il est avantagé.",
            "Cet avantage se terminera dês le commencement de votre prochain tour."
        ]
    },
    {
        ...
        bullets: [
            ...
            "Quand un objet nécessite à lui seul une action particuliêre ou dédiée, vous devez effectuer l'action utiliser un objet comme action à votre tour."
        ]
    },
    {
    ...
    },
    {
        ...
        description: "Se tenir prêt à réagir dês que certaines conditions sont réunies ou déclenchées",
        reference: "PHB, pg. 193.",
        bullets: [
    ...
    },
    {
        ...
        reference: "PHB, pg. 193.",
        bullets: [
            "Si vous souhaitez réaliser une action qui n'est pas décrite dans les rêgles, parlez en à votre MD pour savoir si cette action est recevable, et si un jet de caractéristique est nécessaire pour en déterminer le succês ou l'échec."
        ]
    }
]